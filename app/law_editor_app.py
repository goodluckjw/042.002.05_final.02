...
with col1:
    search_query = st.text_input("검색어 입력", key="search_query", label_visibility="collapsed", placeholder="검색어 입력")
with col2:
...
with col_a:
    find_word = st.text_input("찾을 단어", key="find_word", label_visibility="collapsed", placeholder="찾을 단어")
with col_b:
    replace_word = st.text_input("바꿀 단어", key="replace_word", label_visibility="collapsed", placeholder="바꿀 단어")
with col_c:
